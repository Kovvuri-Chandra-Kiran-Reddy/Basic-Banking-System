...
<body>
    <div id="main">
        <div id="abcd">
            ...
            <a href="../../sparks foundation/Basic-Banking-System/view_all_customers.php" class="underline"> View All Customers </a>
        ...
        <table class="styled-table">
            ...
            <tbody>
                ...
                if ($count > 0) {
                    $query1 = "SELECT * FROM transactions ORDER BY date DESC,time DESC";
